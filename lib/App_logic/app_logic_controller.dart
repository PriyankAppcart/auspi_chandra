...
import 'package:auspi_chandra_flutter/App_logic/advanced_panchang_model.dart';
import 'package:auspi_chandra_flutter/App_logic/commonStorage.dart';
import 'package:auspi_chandra_flutter/App_logic/planets_extended_model.dart';
import 'package:auspi_chandra_flutter/Moon_yog_calc.dart';
import 'package:auspi_chandra_flutter/Notifications/LocalNotificationService.dart';
import 'package:auspi_chandra_flutter/RemoteServices/RemoteServices.dart';
import 'package:auspi_chandra_flutter/RemoteServices/check_internet.dart';
import 'package:auspi_chandra_flutter/auspi_moon_calc.dart';
import 'package:auspi_chandra_flutter/ghatika_calc.dart';
import 'package:auspi_chandra_flutter/moon_rashi_calc.dart';
import 'package:auspi_chandra_flutter/sun_calc_data.dart';
import 'package:auspi_chandra_flutter/timezone_select.dart';
...
class app_logic_controller extends GetxController{
  ...
  * */
  ...
  Map ?Hora_map;
  List Hora_Sunday_list =["","","","Sun-Rajseva",
    "","","Sun-Rajseva","" ,"",
  ...
  List hora_Tuesday_list =["Moon-good for everything","","",
    "Mars-Debate/War","","","Mars-Debate/War",""
    ,"","","Moon-good for everything","",
    "","Mars-Debate/War","",""
    ,"","Moon-good for everything","","",
    "Mars-Debate/War","","","","Moon-good for everything"];

  List hora_Wednesday_list =["","","","Mercury-Learning"
    ,"Moon-good for everything","","Mercury-Learning","Moon-good for everything",
    "","","r","","",
    "Mercury-Learning","Moon-good for everything",""
    ,"","","","","Mercury-Learning",
    "Moon-good for everything","","",""];

  List hora_Thursday_list =["","Moon-good for everything","","Jupiter-Marriage"
    ,"","","Jupiter-Marriage","",""
    ,"","","Moon-good for everything","","Jupiter-Marriage"
    ,"","","","","Moon-good for everything"
    ,"","Jupiter-Marriage","","","",""];

  List hora_Friday_list =["","","","Venus-Journey"
    ,"","Moon-good for everything","Venus-Journey","","Moon-good for everything"
    ,"","","","","Venus-Journey"
    ,"","Moon-good for everything","","",""
    ,"","Venus-Journey","","Moon-good for everything","",""];

  List hora_Saturday_list =["","","Moon-good for everything","Saturn-Saving"
    ,"","","Saturn-Saving","",""
    ,"","","","Moon-good for everything","Saturn-Saving"
    ,"","","","",""
    ,"Moon-good for everything","Saturn-Saving","","","",""];
